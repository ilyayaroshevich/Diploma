...
export async function postRequest(
    url: string,
    sentObject: { name?: string | any; job?: string | any }
): Promise<any> {
    try {
...
export async function putRequest(
    ...
    try {
        const response: any = await superagent.put(url).send(newData)
        return response
    } catch (error: any) {
        return error
    }
...
export async function patchRequest(
    ...
    try {
        const response: any = await superagent.patch(url).send(newData)
        return response
    } catch (error: any) {
        return error
    }
