...
class MainPage extends BasePage {
  ...
  constructor() {
    ...
    this.electronics = $("a[href='/electronics/']")
    ...
    this.watchAllB = $("[href='/special_offers/recommend.html'][class='PopularsList_link__mJ5YM']")
    this.reviewsC = $("[class='ReviewsHome_container__4fngr']")
